sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("Lab_13/Lab_13/app", ".html");
		...
		return Opa5.extend("Lab_13.Lab_13.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["Lab_13/Lab_13/localService/mockserver"], function (mockserver) {
