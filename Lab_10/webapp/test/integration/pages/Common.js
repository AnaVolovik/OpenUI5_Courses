sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("Lab_10/Lab_10/app", ".html");
		...
		return Opa5.extend("Lab_10.Lab_10.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["Lab_10/Lab_10/localService/mockserver"], function (mockserver) {
